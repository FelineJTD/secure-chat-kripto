...
<form class="flex px-4 md:px-8 py-4 bg-neutral-200" on:submit|preventDefault={sendMessage}>
  <input bind:this={input} name="message" type="text" class="w-full border border-neutral-400 rounded-xl p-2 mr-4" maxlength="200" />
